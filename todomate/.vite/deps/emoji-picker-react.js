...
// node_modules/emoji-picker-react/node_modules/clsx/dist/clsx.m.js
function r(e) {
  var t, f, n = "";
...
function useOnEmojiClickConfig() {
  var _usePickerConfig8 = usePickerConfig(), onEmojiClick = _usePickerConfig8.onEmojiClick;
  return onEmojiClick;
}
function usePreviewConfig() {
  var _usePickerConfig9 = usePickerConfig(), previewConfig = _usePickerConfig9.previewConfig;
...
function usePickerSizeConfig() {
  var _usePickerConfig13 = usePickerConfig(), height = _usePickerConfig13.height, width = _usePickerConfig13.width;
  return {
...
function useEmojiVersionConfig() {
  var _usePickerConfig14 = usePickerConfig(), emojiVersion = _usePickerConfig14.emojiVersion;
  return emojiVersion;
}
function useSearchDisabledConfig() {
  var _usePickerConfig15 = usePickerConfig(), searchDisabled = _usePickerConfig15.searchDisabled;
  return searchDisabled;
}
function useSkinTonePickerLocationConfig() {
  var _usePickerConfig16 = usePickerConfig(), skinTonePickerLocation = _usePickerConfig16.skinTonePickerLocation;
  return skinTonePickerLocation;
}
function useUnicodeToHide() {
  var _usePickerConfig17 = usePickerConfig(), unicodeToHide = _usePickerConfig17.unicodeToHide;
  return unicodeToHide;
}
function useGetEmojiUrlConfig() {
  var _usePickerConfig18 = usePickerConfig(), getEmojiUrl = _usePickerConfig18.getEmojiUrl;
  return getEmojiUrl;
}
...
function getElementInNextRow(allElements, currentRow, elementsInRow, index2) {
  var nextRowElements = getNextRowElements(allElements, currentRow, elementsInRow);
  return nextRowElements[index2] || nextRowElements[nextRowElements.length - 1] || null;
}
function getElementInPrevRow(allElements, currentRow, elementsInRow, index2) {
  var prevRowElements = getRowElements(allElements, currentRow - 1, elementsInRow);
  return prevRowElements[index2] || prevRowElements[prevRowElements.length - 1] || null;
}
...
function EmojiList() {
  ...
  }, categories.map(function(categoryConfig, index2) {
    var category = categoryFromCategoryConfig(categoryConfig);
...
function RenderCategory(_ref) {
  var index2 = _ref.index, category = _ref.category, categoryConfig = _ref.categoryConfig;
  ...
  var emojisToPush = !isPastInitialLoad && index2 > 1 ? [] : emojisByCategory(category);
  var hiddenCounter = 0;
...
var index = (0, import_react.memo)(EmojiPicker$1, function(prev, next) {
...
var emoji_picker_react_esm_default = index;
export {
  Categories,
